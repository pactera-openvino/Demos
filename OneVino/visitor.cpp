...
/*
    ...
    pal.setBrush(backgroundRole(), QPixmap("url(:/bt/image/user_hover.png);"));
    setPalette(pal);*/
    ...
    ui->TotalView->setStyleSheet("QTableView{background:transparent;border:1px solid #A7 A7 A7;border-radius:1px;font-size:16px;font-family:'黑体';gridline-color:#A7 A7 A7}"\
             ...
             "QTableView:item{background:transparent;color:#FFFFFF;}");
/*
    ui->SexChart->setStyleSheet("QChartView{background:transparent;border:1px solid #A7 A7 A7;border-radius:1px;font-size:16px;font-family:'黑体';gridline-color:#A7 A7 A7}"\
            "QTableWidget QTableCornerButton::section{background:transparent;}"\
            "QChartView:item{background:transparent;color:#FFFFFF;}"\
            "QChartView:indicator{width:20px;height:20px;}");
*/
