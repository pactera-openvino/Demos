#ifndef VISITORSCENE_H
#define VISITORSCENE_H
...
class VisitorSeceneThread :public QThread
{
    Q_OBJECT
public:
    VisitorSeceneThread();
...
class visitorscene : public QDialog
{
    Q_OBJECT

public:
    void paintEvent(QPaintEvent *);
    explicit visitorscene(QWidget *parent = nullptr);
    ~visitorscene();
...
private:
    Ui::visitorscene *ui;
    VisitorSeceneThread *VisitorScene_thread;   //定义线程类型指针
};

#endif // VISITORSCENE_H
